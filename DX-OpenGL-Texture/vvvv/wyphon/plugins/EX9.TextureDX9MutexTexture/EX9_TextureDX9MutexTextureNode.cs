...
{
	#region PluginInfo
	[PluginInfo(Name = "DX9MutexTexture", Category = "EX9.Texture", Help = "Basic template which creates a texture", Tags = "")]
	#endregion PluginInfo
	public class EX9_TextureDX9MutexTextureNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
