...
//			wcout << "Wyphon: GetD3DTextureInfo " << itr->first << "\n";
	...
	/**
	 * GetD3DTextureShareHandleByName(HANDLE wyphonPartnerHandle, unsigned __int32 wyphonPartnerId, LPCTSTR TextureName )
	 * 
	 ...
	 */
	extern "C" _declspec(dllexport)
	HANDLE GetD3DTextureShareHandleByDescription(HANDLE wyphonPartnerHandle, unsigned __int32 wyphonPartnerId, LPCTSTR TextureName ) {
		WyphonPartnerDescriptor * pWyphonPartner = (WyphonPartnerDescriptor *) wyphonPartnerHandle;
